...
/usr/sbin/daemon -f -u ${user} -o /usr/home/${user}/l2-server-rest/log/app.log /usr/local/openjdk14/bin/java -Xms128m -Xmx1g -jar l2-server-rest.jar
chown -R ${user}:${user} /home/${user}/l2-server-rest
