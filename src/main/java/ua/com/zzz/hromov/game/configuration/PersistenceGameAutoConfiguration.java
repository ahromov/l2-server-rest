package ua.com.zzz.hromov.game.configuration;
...
@EnableJpaRepositories(basePackages = "ua.com.zzz.hromov.game.repo", entityManagerFactoryRef = "gameEntityManager", transactionManagerRef = "gameTransactionManager")
public class PersistenceGameAutoConfiguration {
	...
	return builder.dataSource(dataSource).packages("ua.com.zzz.hromov.game.model").persistenceUnit("l2jgs").build();
    }
